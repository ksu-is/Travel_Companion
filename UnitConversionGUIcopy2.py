...
class Calculator(Frame):
    ...
    def __init__(self, master):
        ...
        self.entry = Entry(master, width=26, font=("Calibri",24))
    ...
    def create_widgets(self):
        ...
        self.tan_bttn = Button(self, text="mm -> in", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
        self.tan_bttn.grid(row=1, column=8)

        self.tan_bttn = Button(self, text="in -> mm", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
        self.tan_bttn.grid(row=1, column=9)
       
        self.tan_bttn = Button(self, text="M -> Yd", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
        self.tan_bttn.grid(row=2, column=6)

        self.tan_bttn = Button(self, text="Yd -> M", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
        ...
        self.tan_bttn = Button(self, text="Gr -> Oz", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
        self.tan_bttn.grid(row=3, column=8)

        self.tan_bttn = Button(self, text="Oz -> Gr", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
        self.tan_bttn.grid(row=3, column=9)

        self.tan_bttn = Button(self, text="Lit -> Gal", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
        self.tan_bttn.grid(row=4, column=6)

        self.tan_bttn = Button(self, text="Gal -> Lit", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
        self.tan_bttn.grid(row=4, column=7)

        self.tan_bttn = Button(self, text="Oz -> Mil", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
        self.tan_bttn.grid(row=4, column=8)

        self.tan_bttn = Button(self, text="Mil -> Oz", width=9, height=4, font=my_font, bg='LightGreen', command=lambda: self.add_chr('tan'))
