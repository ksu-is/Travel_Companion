...
class Calculator(Frame):
    ...
    def create_widgets(self):
        ...
        self.ac_bttn = Button(self, text='CE', width=9, height=4, bg='LightBlue', command=lambda: self.clear_all())
        ...
        self.mod_bttn = Button(self, text="%", width=9, height=4, command=lambda: self.add_chr('%'))
        ...
        self.lpar_bttn = Button(self, text="(", width=9, height=4, bg='LightBlue',  command=lambda: self.add_chr('('))
        self.lpar_bttn.grid(row=2, column=4)

        self.rpar_bttn = Button(self, text=")", width=9, height=4, bg='LightBlue',  command=lambda: self.add_chr(')'))
        self.rpar_bttn.grid(row=2, column=5)

        self.sq_bttn = Button(self, text="√", width=9, height=4, bg='LightBlue',  command=lambda: self.add_chr('√('))
        self.sq_bttn.grid(row=3, column=4)

        self.sqr_bttn = Button(self, text="^", width=9, height=4, bg='LightBlue', font=my_font, command=lambda: self.add_chr('^'))
        self.sqr_bttn.grid(row=3, column=5)

        self.sin_bttn = Button(self, text="C -> F", width=9, height=4, bg='LightGreen', command=lambda: self.convert_CtoF())
        self.sin_bttn.grid(row=1, column=6)

        self.cos_bttn = Button(self, text="F -> C", width=9, height=4, bg='LightGreen', command=lambda: self.convert_FtoC())
        self.cos_bttn.grid(row=2, column=6)

        self.tan_bttn = Button(self, text="tan", width=9, height=4, bg='LightGreen', command=lambda: self.add_chr('tan'))
        ...
        self.tan_bttn = Button(self, text="tan", width=9, height=4, bg='LightGreen', command=lambda: self.add_chr('tan'))
        self.tan_bttn.grid(row=1, column=7)
...
root = Tk()
root.geometry()
root.title("Unit conversion travel companion")
app = Calculator(root)
root.mainloop()